resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              =  "web-${var.environment}.${var.zone_name}"#web-dev.avyan.site
  ...
  aliases = ["web-${var.common_tags.Component}.${var.zone_name}"]#web-cdn.avyan.site
...
module "records" {
  ...
  records = [
    {
      name    = "web-cdn" #web-cdn.avyan.site
      type    = "A"
